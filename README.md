...
The core intelligence resides in the sysCall_actuation() function, which defines a Finite State Machine (FSM) using the avoidanceState variable to manage the robot's complex behavior transitions.
